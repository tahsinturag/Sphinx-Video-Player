...
import com.example.sphinx.databinding.ActivityMainBinding
import com.example.sphinx.databinding.ThemeViewBinding
...
//            Handler(Looper.getMainLooper()).postDelayed(runnable!!, 0)
        ...
        binding.bottomNav.setOnItemSelectedListener {
            when (it.itemId) {
                ...
                //R.id.userView -> setFragment(UsersFragment())
