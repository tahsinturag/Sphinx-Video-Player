...
import com.example.sphinx.databinding.DetailsViewBinding
import com.example.sphinx.databinding.RenameFieldBinding
import com.example.sphinx.databinding.VideoMoreFeaturesBinding
import com.example.sphinx.databinding.VideoViewBinding
...
class VideoAdapter(private val context: Context, private var videoList: ArrayList<Video> , private var isFolder: Boolean = false) : RecyclerView.Adapter<VideoAdapter.MyHolder>() {
    ...
    override fun onBindViewHolder(holder: MyHolder, @SuppressLint("RecyclerView") position: Int) {
        ...
        Glide.with(context)
            ...
            .apply(RequestOptions().placeholder(R.mipmap.ic_sphinx).centerCrop())
            .into(holder.image)
